                    ...
                    <ul class="footer-contacts d-inline-block d-md-block">
                      <li>
                        <div class="unit unit-spacing-xs">
                          ...
                          <div class="unit-body"><a class="link-phone" href="http://api.whatsapp.com/send?1=pt_BR&phone=5513981457896">13 98177-6198</a></div>
                        </div>
                      </li>
                      <li>
                        <div class="unit unit-spacing-xs">
                      ...
                      <li>
                        <div class="unit unit-spacing-xs">
                          ...
                          <div class="unit-body"><a class="link-location" href="#">Rua X, Bairro Y, São Paulo 30515-522</a></div>
                        </div>
                      </li>
                    </ul>
                  </div>
                    ...
                    <div class="row row-10 gutters-10" data-lightgallery="group">
                      <div class="col-6 col-sm-3 col-lg-6">
                        ...
                        <article class="thumbnail thumbnail-mary">
                          <div class="thumbnail-mary-figure"><img src="images/galeria-loja/01.jpg" alt="" width="129" height="120"/>
                          </div>
                      ...
                      <div class="col-6 col-sm-3 col-lg-6">
                        <!-- Thumbnail Classic-->
                        <article class="thumbnail thumbnail-mary">
                          <div class="thumbnail-mary-figure"><img src="images/galeria-loja/02.jpg" alt="" width="129" height="120"/>
                          </div>
                      ...
                      <div class="col-6 col-sm-3 col-lg-6">
                        <!-- Thumbnail Classic-->
                        <article class="thumbnail thumbnail-mary">
                          <div class="thumbnail-mary-figure"><img src="images/galeria-loja/03.jpg" alt="" width="129" height="120"/>
                          </div>
                      ...
                      <div class="col-6 col-sm-3 col-lg-6">
                        <!-- Thumbnail Classic-->
                        <article class="thumbnail thumbnail-mary">
                          <div class="thumbnail-mary-figure"><img src="images/galeria-loja/04.jpg" alt="" width="129" height="120"/>
                          </div>
