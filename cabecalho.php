                      ...
                      <ul class="rd-navbar-modern-contacts">
                        ...
                        <li>
                          <div class="unit unit-spacing-sm">
                            ...
                            <div class="unit-body"><a class="link-email" href="mailto:#">exemplo@exemplo.com</a></div>
                          </div>
                        </li>
                      </ul>
                      <ul class="list-inline rd-navbar-modern-list-social">
                        <li><a title="Ir para página no facebook" class="icon fa fa-facebook" href="#"></a></li>
                        <li><a title="Ir para página no twitter" class="icon fa fa-twitter" href="#"></a></li>
                        <li><a title="Ir para página do google plus" class="icon fa fa-google-plus" href="#"></a></li>
                        <li><a title="Ir na página do instragram" class="icon fa fa-instagram" href="#"></a></li>
                        <li><a title="Ir para página do painterest" class="icon fa fa-pinterest" href="#"></a></li>
                      </ul>
                    </div>
                  </div>
                </div>
